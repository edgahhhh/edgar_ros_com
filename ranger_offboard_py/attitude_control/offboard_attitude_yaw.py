...
class OffboardControl(Node):
    def __init__(self):
        ...
        self.yaw_time = 0
        self.yaw_period = 10   # s
        self.yaw_omega = 2*np.pi/self.roll_period  # rad/s
        self.yaw_amp = np.pi*1/6   # rad
        self.yaw_min = np.pi/2    # rad
    ...
    def attitude_timer_callback(self):
        ...
        if self.vehicle_status.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD:
            ...
            self.euler_setpoint_r = self.yaw_min + self.yaw_amp*np.sin(self.yaw_omega*self.yaw_time_time)
            ...
            self.yaw_time += self.attitude_timer_period
