...
class OffboardControl(Node):
    def __init__(self):
        ...
        self.roll_time = 0
        self.roll_period = 10   # s
        self.roll_omega = 2*np.pi/self.roll_period  # rad/s
        self.roll_amp = np.pi*1/6   # rad
    ...
    def attitude_timer_callback(self):
        ...
        if self.vehicle_status.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD:
            ...
            self.euler_setpoint_p = self.roll_min+self.roll_amp*np.sin(self.roll_omega*self.roll_time)
            ...
            self.roll_time += self.attitude_timer_period
